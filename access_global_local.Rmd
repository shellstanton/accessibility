...
# Change class of LATITUDE and LONGITUDE columns to numeric
...
# Store coordiantes as object
mwi_mfl_coord <-  mwi_mfl[c("LATITUDE", "LONGITUDE")]
# Check
# View(mwi_mfl_coord)


### Create SpatialPointsDataFrame (with CRS of 'leastcost_motor')
mwi_mfl_spdf <- SpatialPointsDataFrame(coords = mwi_mfl_coord,
                                       proj4string = crs(leastcost_motor),
                                       data = mwi_mfl)
...
### Create SpatialPoints object (with CRS of 'leastcost_motor')
mwi_mfl_sp <- SpatialPoints(coords = mwi_mfl_coord,
...
# Crop to extent of 'friction_surface_motor'
mwi_mfl_spdf_crop <- crop(mwi_mfl_spdf, friction_surface_motor)
mwi_mfl_spdf_crop
# NULL
