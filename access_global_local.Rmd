...
### Attempted to convert lcm_pop_data_rcl to polygon(s) using 'rasterToPolygons' but took 3+ hours ans so cancelled
...
Option_5: Create polygon(s) from 'lcm_pop_data_rcl' using 'stars' package and submit to WorldPop
```{r, warning=FALSE}
...
test <- df_to_SpatialPolygons(lcm_rcl_pop_data_df, "mins", c("x","y"), CRS())
plot(test)
