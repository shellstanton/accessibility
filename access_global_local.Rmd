...
# Try to dissolve using 'rmapshaper' package ???
...
# use 'st_cast' again to convet from multipolygon to polygon
...
## POST-st_dissolve: Trying to send 9222 tasks to WorldPop...
...
lcm_pop_data_rcl_stars_sf_polygon_lines_polygon <- st_cast(lcm_pop_data_rcl_stars_sf_polygon_lines, "POLYGON")
