...
### Option_4: Download population rasters from WorldPop, extract from population rasters using reclasified time-boundary rasters (rather than polygons)
```{r WorldPop_packages}

## Download, install and load wpgpCovariates: an R Package interface for downloading raster datasets from WorldPop FTP.
...
# Download dataframe of avaliable covariates for country of interest
...
wpgpGetCountryDataset(ISO3 = ISO3,
                      covariate = "ppp_2020", # This needs to be chosen?
                      destDir = "./WorldPop")
...
## Reclassify 'leastcost_motor' to time-boundary categorical zones
...
## Determine population totals within each time-boundary category and summate
