...
=======
### Option_1: Extract time-boundary polygons from 'leastcost_motor' ??? (*not working*)
```{r isolate_time_boundary_polygons, include=FALSE}
...
=======
### Option_2: Subset time-boundary data from data.frame, create polygon(s) and submit to WorldPop ??? (*not working*)
>>>>>>> Stashed changes
