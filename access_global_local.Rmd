...
# Now we wish to calculate the population within 30 minutes (etc) of a healthcare facility
...
# Extract population data from 'pop_data' by using 'thirty_min_polygoy_agg' ???
thirty_min_population <- extract(pop_data, thirty_min_polygoy_agg)
View(thirty_min_population)
sum(thirty_min_population$mwi_ppp_2020)
## None work.
