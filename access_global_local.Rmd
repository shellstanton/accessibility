...
### Extract time-boundary polygons from 'leastcost_motor' ???
...
### Subset time-boundary data, create polygon(s) and submit to WorldPop ???
...
# Save as shapefile
writeOGR(thirty_min_polygon_agg_df, dsn = "thirty_min_polygon_agg_df", layer = "thirty_min_polygon_agg_df", driver = "ESRI Shapefile")
...
### Download population rasters from WorldPop, subset time-boundary data, create polygon(s) and extract from population rasters using polygon(s) ???
...
### Extract from population rasters using polygon(s) (30 min)
...
## Create raster from subsetted data.frame ???
...
### Extract from population rasters using polygon(s) (60 min)
