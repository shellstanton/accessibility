...
# * Define max and minimum values for longitude and latitude using coordinate points (WGS84)
bbxmin <- 33.2
bbxmax <- 33.8
bbymin <- -11.29
bbymax <- -10.73
...
Setup: Landsat 8 parameters
```{r setup_landsat8_parameters}

# Read in landsat 8 data
ls8_data <- "LANDSAT/LC08/C01/T1_RT_TOA"

# Define start and end dates to filter by
start_date <-  "2018-06-01"
end_date   <-  "2018-09-30"

```

Setup: NDVI parameters
```{r setup_NDVI_parameters}

## NDVI parameters

```

Setup: Road travel speeds
```{r setup_road_travel_speeds}
...
# Set country of interest using British English spelling
COI <- "Malawi"
