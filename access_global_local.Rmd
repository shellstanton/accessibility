...
##### Create polygon from data.frame ???
...
### Option_5: Use 'stars' package to generate polygon(s) to save as .shp and submit to WorldPop 
```{r}
...
# Convert from linestring to polygon *doesn't seem to work* ???
...
# lcm_pop_data_rcl_stars_sf_polygon_agg <- aggregate(lcm_pop_data_rcl_stars_sf_polygon, by = "mins", FUN = "mean")
